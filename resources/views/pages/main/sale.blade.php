    ...
    <div class="container">
      ...
      <div class="col-lg-8 ftco-animate">
        <div class="text w-100 text-center mb-md-5 pb-md-5">
          <h1 class="mb-4"> Effortless &amp; Car Purchases: Quick and Convenient</h1>
          <p style="font-size: 18px;">Discover a seamless car-buying experience with our services</p>
            ...
            <div class="col-md-12	featured-top">
                <div class="row no-gutters">
                    <div class="col-md-4 d-flex align-items-center">
                        <form action="/payment" class="request-form ftco-animate bg-primary">
